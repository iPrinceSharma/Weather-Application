This is a web-application developed on MVC Pattern. For this application I have used Openweather API, which can show data in real time when user request a query. 
